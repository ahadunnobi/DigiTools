...
const Hero = () => {
  return (
    <section className="bg-white px-6 sm:px-12 lg:px-24 flex flex-col lg:flex-row items-center justify-between gap-12 max-w-[1280px] mx-auto min-h-[calc(100vh-80px)] pt-5">
      {/* Left Content */}
